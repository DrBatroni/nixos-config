  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mod = $mainMod SHIFT, left, swapwindow, l"
        "$mod = $mainMod SHIFT, right, swapwindow, r"
        "$mod = $mainMod SHIFT, up, swapwindow, u"
        "$mod = $mainMod SHIFT, down, swapwindow, d"
        ...
        "$mod = $mainMod ALT, right, movewindow, mon:+1"
        "$mod = $mainMod ALT, left, movewindow, mon:-1"

        # Monitor-Fokus ohne Fensterwechsel wechseln
        "$mod = $mainMod, comma, focusmonitor, -1"
        "$mod = $mainMod, period, focusmonitor, +1"

        # Pixelweise Vergrößern/Verkleinern (X Y)
        "$mod = $mainMod CTRL, right, resizeactive, 30 0"
